      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center h-50 overflow-hidden rounded-lg">
        <div className="text-side flex flex-col justify-center items-start p-8 md:p-16 bg-gray-200">
          <div className="text">
            ...
            <Link
              to="/kidproductpage"
              className="bg-black text-white text-lg md:text-xl font-semibold py-4 px-8 uppercase border-2 border-black transition duration-150 hover:bg-fadeCustom hover:text-black rounded-lg"
            >
              Show All
            </Link>
          </div>
